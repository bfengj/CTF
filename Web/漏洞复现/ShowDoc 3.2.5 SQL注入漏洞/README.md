...
`/api/item/pwd`的`$item_id`存在SQL注入：

![image-20240612124700113](README.assets/image-20240612124700113.png)
...
![image-20240612125052195](README.assets/image-20240612125052195.png)

## References

https://github.com/vulhub/vulhub/blob/master/showdoc/3.2.5-sqli/README.zh-cn.md