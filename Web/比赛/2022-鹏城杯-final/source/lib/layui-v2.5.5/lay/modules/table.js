...
layui.define(['laytpl', 'laypage', 'layer', 'form', 'util'], function(exports){
  ...
  Class.prototype.events = function(){
    ...
    that.layBody.on('click', 'td', function(e){
	  var lielie = e.currentTarget.attributes[1].value
      var othis = $(this)
	  ...
	  var hanghang = othis.parents('tr').eq(0).data('index')
      
      //显示编辑表单
      if(editType){
        var input = $('<input id="ixi_'+hanghang+'_'+lielie+'" class="layui-input '+ ELEM_EDIT +'">');
