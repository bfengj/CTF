    ...
    layui.use(['form', 'table','soulTable'], function () {
	  ...
	  ,rowDrag: {trigger: 'row', done: function(obj) {
            ...
            cols: [[
                ...
                {field: 'user', width: 120, title: '操作者', align: "center"},
                {field: 'action', width: 300, title: '动作', sort: true, align: "center"},
				{field: 'ip', width: 150, title: 'IP', align: "center"},
		...
		form.on('switch(Changezt)', function(obj){
			$.post("../action.php",{mode:"chengezcztzt",id:this.value,zhi:obj.elem.checked},function(result){
				console.log(result);
