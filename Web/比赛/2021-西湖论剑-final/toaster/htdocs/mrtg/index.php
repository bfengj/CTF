...
function parse_mrtg( $file ) {
	...
	$limitatori = array(
					"daily" => array ( "<!-- Begin `Daily' Graph \(10 Minute interval\) -->" , "<!-- End `Daily' Graph \(10 Minute interval\) -->" ),
					"weekly"=> array ( "<!-- Begin `Weekly' Graph \(30 Minute interval\) -->" , "<!-- End `Weekly' Graph \(30 Minute interval\) -->" ),
					"monthly" => array ( "<!-- Begin `Monthly' Graph \(2 Hour interval\) -->" , "<!-- End `Monthly' Graph \(2 Hour interval\) -->" ) ,
					"yearly"  => array ("<!-- Begin `Yearly' Graph \(1 Day interval\) -->" , "<!-- End `Yearly' Graph \(1 Day interval\) -->") ) ;
