...
INSERT INTO `s` VALUES ('wdwd','wdwd');
...
CREATE USER 'rctf'@'%' identified by 'ad846ebd-ae19-4ef4-ab12-c47147a2c7f3';
...
CREATE USER 'rctf2'@'%' identified by 'e5176ce9-5d8a-4e3b-bee8-72c716b66a2d';
