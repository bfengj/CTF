...
$(document).ready(function(){
	{params}
	var modenum = 'scheduld',modename='日程待办',isflow=1,modeid='99',atype = params.atype,pnum=params.pnum,modenames='',listname='c2NoZWR1bGQ:';
