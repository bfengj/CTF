...
c.initpage=function(){
	$('#key_{rand}').parent().before('<td><input onclick="js.datechange(this,\'month\')" style="width:110px;border-radius:0;border-left:0;'+datesss+'" placeholder="签约月份" readonly class="form-control" id="dt_{rand}" ></td>');
}
