...
c.initpage=function(){
	$('#key_{rand}').parent().before('<td><input onclick="js.datechange(this,\'date\')" style="width:110px;border-radius:0;border-left:0;'+datesss+'" placeholder="借阅日期" readonly class="form-control" id="dt_{rand}" ></td>');
}
