...
$(document).ready(function(){
	{params}
	var modenum = 'book',modename='图书管理',isflow=0,modeid='45',atype = params.atype,pnum=params.pnum,modenames='',listname='Ym9vaw::';
...
if(pnum=='all'){
	...
	var shtm = '<table width="100%"><tr valign="top"><td><div style="border:1px #cccccc solid;width:220px"><div id="optionview_{rand}" style="height:400px;overflow:auto;"></div></div></td><td width="8" nowrap><div style="width:8px;overflow:hidden"></div></td><td width="95%"><div id="viewbook_{rand}"></div></td></tr></table>';
	$('#viewbook_{rand}').after(shtm).remove();
	c.stable = 'book';
	c.optionview = 'optionview_{rand}';
	c.optionnum = 'booktype';
	c.title = '图书分类';
	c.rand = '{rand}';
	...
	$('#tdright_{rand}').prepend(c.getbtnstr('所有图书','allshow')+'&nbsp;&nbsp;');
