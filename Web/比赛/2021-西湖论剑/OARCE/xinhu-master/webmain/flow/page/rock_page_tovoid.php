...
*	模块：tovoid.单据作废申请
*	说明：自定义区域内可写你想要的代码
*	来源：流程模块→表单元素管理→[模块.单据作废申请]→生成列表页
*/
...
$(document).ready(function(){
	{params}
	var modenum = 'tovoid',modename='单据作废申请',isflow=1,modeid='52',atype = params.atype,pnum=params.pnum,modenames='',listname='dG92b2lk';
