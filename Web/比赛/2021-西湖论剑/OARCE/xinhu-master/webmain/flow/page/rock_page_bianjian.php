...
$(document).ready(function(){
	{params}
	var modenum = 'bianjian',modename='便笺',isflow=0,modeid='82',atype = params.atype,pnum=params.pnum,modenames='',listname='YmlhbmppYW4:';
...
c.initpage=function(){
	a.settishi('<div class="tishi">需要提醒点操作下的“添加提醒设置”进行设置</div>');
};
