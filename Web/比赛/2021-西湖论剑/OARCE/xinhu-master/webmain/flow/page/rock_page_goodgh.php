...
$(document).ready(function(){
	{params}
	var modenum = 'goodgh',modename='物品归还',isflow=1,modeid='100',atype = params.atype,pnum=params.pnum,modenames='归还物品',listname='Z29vZG0:';
...
<div>
	...
	<tr>
		...
		<td><select class="form-control" style="width:120px;border-left:0;border-radius:0;" id="selstatus_{rand}"><option value="">-全部状态-</option><option style="color:blue" value="0">待确认</option><option style="color:green" value="1">已归还</option><option style="color:#888888" value="5">已作废</option><option style="color:#17B2B7" value="23">退回</option></select></td>
		<td>
