...
Object.defineProperty(HTMLScriptElementImpl, 'init', {
  value: function (obj, privateData) {
    obj._attach = function () {
      (0, _getPrototypeOf2.default)(this.constructor).prototype._attach.call(this);
...
function enhanceStackTrace(error, document_ref) {
  ...
  if (error.stack) for (let line of error.stack.split('\n')) {
...
const jsMIMETypes = new _set2.default(['application/ecmascript', 'application/javascript', 'application/x-ecmascript', 'application/x-javascript', 'text/ecmascript', 'text/javascript', 'text/javascript1.0', 'text/javascript1.1', 'text/javascript1.2', 'text/javascript1.3', 'text/javascript1.4', 'text/javascript1.5', 'text/jscript', 'text/livescript', 'text/x-ecmascript', 'text/x-javascript']);
