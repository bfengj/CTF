...
<div id="tb">
 ...
 <table cellpadding="0" cellspacing="0" width="100%" class="table_info1">
	...
	<tr>
		...
		<tr>
		  <td class="w1">邮件结尾说明:</td><td class="w2"><textarea name="mail_jw" style="width:95%; height:50px;"><?php echo empty($_sys['mail_jw'])?'BEESCMS企业网站管理系统 http://www.beescms.com':$_sys['mail_jw'];?></textarea></td><td class="w3"></td>
		</tr>
		<tr>
